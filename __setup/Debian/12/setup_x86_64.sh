...
APT_SOURCES_DIR="$HOME/.config/apt/Debian/12/sources.list.d"
...
APT_CONF_DIR="$HOME/.config/apt/Debian/12/apt.conf.d"
...
OFFICIAL_PACKAGES=$HOME/.config/apt/Debian/12/packages.list
...
source "$SHARED_DIR/install_neovim.sh"
source "$SHARED_DIR/install_ultimakerCura.sh"
